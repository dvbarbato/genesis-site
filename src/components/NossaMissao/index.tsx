        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 text-gray-500 space-y-6">
              <p className="text-lg">
                Atender bem e prontamente a todas as pessoas sendo referência no ramo de Consultoria e Despachante Bélico.
                Entregar cada vez mais e com melhor qualidade nossos serviços
                Respeito às pessoas, às leis e ao meio ambiente superando as expectativas
              </p>
            </div>
          </div>
        </div>
